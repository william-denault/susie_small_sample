...
true_beta=2
lol <- comp_bf_ran(n=30,beta = true_beta,s0=1 )
plot(lol[,1],lol[,2], xlab="Servin & Stephens log BF  ", ylab="log BF",
     main="n=30, beta = 1,s0=1", pch=19, col="blue")
...
lol <- comp_bf_ran(n=30,beta = true_beta,s0=true_beta )
plot(lol[,1],lol[,2], xlab="Servin & Stephens log BF  ", ylab="log BF",
     main="n=30, beta = 2,s0=2", pch=19, col="blue")
points(lol[,1],lol[,3], pch=19, col="green")
abline(a=0,b=1)
...
lol <- comp_bf_ran(n=30,beta = true_beta,s0=5 )
plot(lol[,1],lol[,2], xlab="Servin & Stephens log BF  ", ylab="log BF",
     main="n=30, beta = 2, s0=5", pch=19, col="blue")
points(lol[,1],lol[,3], pch=19, col="green")
abline(a=0,b=1)
