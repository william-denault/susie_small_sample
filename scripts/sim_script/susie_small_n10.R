...
for ( o in 1:10000){
  ...
  if(file.exists("./simulations/small_sample_susie10_h25.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie10_h25.RData")


  temp0 <- run_susie_sim(N=10, h=0.50, n_sim=100)

  if(file.exists("./simulations/small_sample_susie10_h50.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie10_h50.RData")


  temp0 <- run_susie_sim(N=10, h=0.30, n_sim=100)

  if(file.exists("./simulations/small_sample_susie10_h30.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie10_h30.RData")
