...
for ( o in 1:100000){
  ...
  if(file.exists("./simulations/small_sample_susie20_h25.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie20_h25.RData")

  temp0 <- run_susie_sim(N=20, h=0.50, n_sim=100)

  if(file.exists("./simulations/small_sample_susie20_h50.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie20_h50.RData")

  temp0 <- run_susie_sim(N=20, h=0.3, n_sim=100)
  if(file.exists("./simulations/small_sample_susie20_h30.RData")){
  ...
  save(temp, file="./simulations/small_sample_susie20_h30.RData")
}
