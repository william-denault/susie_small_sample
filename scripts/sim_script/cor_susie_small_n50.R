...
for ( o in 1:10000){
  ...
  save(temp, file="./simulations/cor_small_sample_susie50_h25.RData")
  ...
  save(temp, file="./simulations/cor_small_sample_susie50_h50.RData")
  ...
  save(temp, file="./simulations/cor_small_sample_susie50_h30.RData")
