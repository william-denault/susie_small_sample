...
for ( o in 1:100000){
  ...
  if(file.exists("/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h30.RData")){
    load("/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h30.RData")
    if(!is.null(temp)){
      temp <- rbind (temp, temp0)
    }else{
      temp <- temp0
  ...
  save(temp, file="/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h30.RData")


  temp0 <- run_susie_sim(N=30, h=0.75, n_sim=100)
  if(file.exists("/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h75.RData")){
    load("/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h75.RData")
    if(!is.null(temp)){
      temp <- rbind (temp, temp0)
    }else{
      temp <- temp0
  ...
  save(temp, file="/home/wdenault/susie_small_sample/simulations/cor_small_sample_susie30_h75.RData")
}
