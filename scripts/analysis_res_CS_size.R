...
load("C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_small_sample/sim/small_sample_susie10_h25.RData")
...
load("C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_small_sample/sim/small_sample_susie10_h30.RData")
obs_cs_size <- rep( NA, 10)
for ( i in 1:10){
  obs_cs_size[i] <-mean( temp[which(temp[,3] == (i )),4] ) 
}
...
load("C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_small_sample/sim/small_sample_susie10_h50.RData")
obs_cs_size <- rep( NA, 10)
for ( i in 1:10){
  obs_cs_size[i] <- mean( temp[which(temp[,3] == (i )),4] ) 
}
...
load("C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_small_sample/sim/small_sample_susie20_h25.RData")
obs_cs_size <- rep( NA, 10)
for ( i in 1:10){
  obs_cs_size[i] <- mean( temp[which(temp[,3] == (i )),4] ) 
} 
...
load("C:/Document/Serieux/Travail/Data_analysis_and_papers/susie_small_sample/sim/small_sample_susie50_h25.RData")
obs_cs_size <- rep( NA, 10)
for ( i in 1:10){
  obs_cs_size[i] <- mean( temp[which(temp[,3] == (i )),4] ) 
}
